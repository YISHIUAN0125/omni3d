...
def get_cfg_defaults(cfg):
    ...
    # TSR
    cfg.MODEL.ROI_CUBE_HEAD.NAME = 'TSRCubeHead'
    cfg.MODEL.ROI_CUBE_HEAD.TSR = CN()
    cfg.MODEL.ROI_CUBE_HEAD.TSR.TOKEN_DIM = 256
    cfg.MODEL.ROI_CUBE_HEAD.TSR.HIDDEN_DIM = 128
    cfg.MODEL.ROI_CUBE_HEAD.TSR.TEMPERATURE = 1.0
    cfg.MODEL.ROI_CUBE_HEAD.TSR.BOTTLENECK_RATIO = 0.5